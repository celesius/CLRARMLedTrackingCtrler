...
void CLRMPU9250::readAccelData(int16_t * destination)
{
...
void CLRMPU9250::readGyroData(int16_t * destination)
{
...
void CLRMPU9250::readMagData(int16_t * destination)
{
...
int16_t CLRMPU9250::readTempData()
{
...
void CLRMPU9250::resetMPU9250() {
	// reset device
	writeByte(MPU9250_ADDRESS, PWR_MGMT_1, 0x80); // Write a one to bit 7 reset bit; toggle reset device
	wait(0.1);
}

void CLRMPU9250::initAK8963(float * destination)
{
...
void CLRMPU9250::calibrateMPU9250(float * dest1, float * dest2)
{
...
void CLRMPU9250::MPU9250SelfTest(float * destination) // Should return percent deviation from factory trim values, +/- 14 or less deviation is a pass
{
...
void CLRMPU9250::MadgwickQuaternionUpdate(float adelay, float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
{
